...
def plot_history(history):
    ...
    plt.plot(epochs_as_array, train_loss_history, "blue")
    plt.plot(epochs_as_array, val_loss_history, "red")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.xlim(0, 11)
    plt.ylim(0, 1)
    ...
    plt.plot(epochs_as_array, train_acc_history, "blue")
    plt.plot(epochs_as_array, val_acc_history, "red")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.xlim(0, 11)
    plt.ylim(0, 1)
...
def train_and_select_model(train_csv, model_type=''):
    ...
    x_train, y_train = get_train_data(train_csv)
...
if __name__ == '__main__':
    ...
    if grading_mode:
        ...
        mlp_model = train_and_select_model(train_file)
